...
beans {
	...
	doc1(Document) {
		name = "Book Template"
		type = ref("pdfType")
		location = "D:/temp/filipeg/Documents/Random/Book Template.pdf"
	}

	doc2(Document) {
		name = "Sample Contract"
		type = ref("pdfType")
		location = "D:/temp/felipeg/Documents/Contracts/Sample Contract.pdf"
	}

	doc3(Document) {
		name = "Clustering with RabbitMQ"
		type = ref("noteType")
		location = "D:/temp/felipeg/Documents/Random/Clustering with RabbitMQ.txt"
	}
